			...
			Queue.mainQueue().async {
				if let strongSelf = self {
					...
					if strongSelf.presentationData != controllerState.presentationData {
						...
						strongSelf.navigationBar?.updatePresentationData(NavigationBarPresentationData(theme: NavigationBarTheme(rootControllerTheme: strongSelf.presentationData.theme,  hideSeparator: strongSelf.hideNavigationBarBackground), strings: NavigationBarStrings(presentationStrings: strongSelf.presentationData.strings)))
