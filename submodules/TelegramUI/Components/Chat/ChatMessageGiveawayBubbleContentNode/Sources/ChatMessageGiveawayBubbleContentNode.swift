...
public class ChatMessageGiveawayBubbleContentNode: ChatMessageBubbleContentNode, ASGestureRecognizerDelegate {
    ...
    override public func asyncLayoutContent() -> (_ item: ChatMessageBubbleContentItem, _ layoutConstants: ChatMessageItemLayoutConstants, _ preparePosition: ChatMessageBubblePreparePosition, _ messageSelection: Bool?, _ constrainedSize: CGSize, _ avatarInset: CGFloat) -> (ChatMessageBubbleContentProperties, CGSize?, CGFloat, (CGSize, ChatMessageBubbleContentPosition) -> (CGFloat, (CGFloat) -> (CGSize, (ListViewItemUpdateAnimation, Bool, ListViewItemApply?) -> Void))) {
        ...
        return { item, layoutConstants, _, _, constrainedSize, _ in
            ...
            let backgroundColor = incoming ? item.presentationData.theme.theme.custom.incomingBubble.first! : item.presentationData.theme.theme.custom.outgoingBubble.first!
            ...
            if badgeTextColor.distance(to: accentColor) < 1 {
                badgeTextColor = incoming ? item.presentationData.theme.theme.custom.incomingBubble.first! : item.presentationData.theme.theme.custom.outgoingBubble.first!
            }
