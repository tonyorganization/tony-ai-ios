        ...
        return { context in
            ...
            if component.valueInfo.valueIsAverage {
                ...
                if component.valueInfo.isLastSaleOnFragment {
                    ...
                    descriptionText = strings.Gift_Value_DescriptionLastPriceAppName(giftTitle).string
                }
            }
                        ...
                        content: AnyComponent(
                            HStack([
                                ...
                                AnyComponentWithIdentity(id: "label", component: AnyComponent(
                                    MultilineTextComponent(text: .plain(NSAttributedString(string: "  \(strings.Gift_Value_ForSaleOnAppName)", font: Font.regular(17.0), textColor: theme.actionSheet.controlAccentColor)))
                                )),
