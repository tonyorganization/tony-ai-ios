                ...
                for index in visibleItems.lowerBound ..< visibleItems.upperBound {
                    ...
                    case let .peer(peer):
                        if let months = item.premiumGiftMonths {
                            ...
                            itemSubtitle = environment.strings.Stars_Intro_Transaction_AppNamePremium(months)
                    ...
                    case .ads:
                        itemTitle = environment.strings.Stars_Intro_Transaction_AppNameAds_Title
                        itemSubtitle = environment.strings.Stars_Intro_Transaction_AppNameAds_Subtitle
                    case .apiLimitExtension:
                        itemTitle = environment.strings.Stars_Intro_Transaction_AppNameBotApi_Title
                        if let floodskipNumber = item.floodskipNumber {
                            itemSubtitle = environment.strings.Stars_Intro_Transaction_AppNameBotApi_Messages(floodskipNumber)
                        } else {
                            itemSubtitle = nil
                        }
                    case .unsupported:
