                ...
                if let starGift = transaction.starGift {
                    ...
                    case let .peer(peer):
                        if let months = transaction.premiumGiftMonths {
                            ...
                            titleText = strings.Stars_Transaction_AppNamePremium(months)
                    ...
                    case .ads:
                        titleText = strings.Stars_Transaction_AppNameAds_Title
                        via = strings.Stars_Transaction_AppNameAds_Subtitle
                    case .apiLimitExtension:
                        titleText = strings.Stars_Transaction_AppNameBotApi_Title
                    case .unsupported:
                        titleText = strings.Stars_Transaction_Unsupported_Title
                    }
                    
                    if let floodskipNumber = transaction.floodskipNumber {
                        descriptionText = strings.Stars_Transaction_AppNameBotApi_Messages(floodskipNumber)
                    } else if !transaction.media.isEmpty {
