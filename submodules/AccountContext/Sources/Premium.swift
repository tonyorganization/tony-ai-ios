...
public struct PremiumConfiguration {
    public static var defaultValue: PremiumConfiguration {
        return PremiumConfiguration(
			// TODO: Ton - Premium disabled default value s
    ...
    fileprivate init(
		...
		// TODO: Ton - Premium disabled
		self.isPremiumDisabled = true
		self.areStarsDisabled = true
        //self.isPremiumDisabled = isPremiumDisabled
        //self.areStarsDisabled = areStarsDisabled
        self.subscriptionManagementUrl = subscriptionManagementUrl
		// TODO: Ton - Premium disabled
		self.showPremiumGiftInAttachMenu = false
		self.showPremiumGiftInTextField = false
		self.giveawayGiftsPurchaseAvailable = false
		self.starsGiftsPurchaseAvailable = false
		self.starGiftsPurchaseBlocked = true
