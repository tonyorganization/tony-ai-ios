...
public protocol SharedAccountContext: AnyObject {
	...
	func simpleTextAlert(text: String) -> AlertController
	
	func confirmTextAlert(text: String,action: @escaping () -> Void) -> AlertController
	
	// TODO: Ton - Translate: api
	func postTranslateText(text: String, language: String) -> Signal<String?, NoError>
	

	func fetchLanguages() -> Signal<[LanguageItemInfo]?, NoError>
