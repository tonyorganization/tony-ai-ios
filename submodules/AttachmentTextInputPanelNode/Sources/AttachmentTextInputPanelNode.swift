...
public class AttachmentTextInputPanelNode: ASDisplayNode, TGCaptionPanelView, ASEditableTextNodeDelegate, ChatInputTextNodeDelegate {
    ...
    public init(context: AccountContext, presentationInterfaceState: ChatPresentationInterfaceState, glass: Bool = false, isCaption: Bool = false, isAttachment: Bool = false, isScheduledMessages: Bool = false, presentController: @escaping (ViewController) -> Void, makeEntityInputView: @escaping () -> AttachmentTextInputPanelInputView?) {
		...
		// TODO: Ton - ChatInput:
		self.textInputContainer.backgroundColor = .clear
		...
		// TODO: Ton - Chat: Input backgrself.addSubnode(self.textInputContainer)
    ...
    public func updateLayout(width: CGFloat, leftInset: CGFloat, rightInset: CGFloat, bottomInset: CGFloat, additionalSideInsets: UIEdgeInsets, maxHeight: CGFloat, isSecondary: Bool, transition: ContainedViewLayoutTransition, interfaceState: ChatPresentationInterfaceState, metrics: LayoutMetrics, isMediaInputExpanded: Bool) -> CGFloat {
        ...
        if self.presentationInterfaceState != interfaceState || !hadLayout {
            ...
            if self.theme !== interfaceState.theme {
                ...
                self.textInputBackgroundImageNode.image = textInputBackgroundImage(
					backgroundColor: backgroundColor,
					inputBackgroundColor: nil,
					strokeColor: interfaceState.theme.chat.inputPanel.inputStrokeColor,
					diameter: minimalInputHeight,
					caption: self.isCaption
				)
                self.transparentTextInputBackgroundImage = textInputBackgroundImage(
					backgroundColor: nil,
					inputBackgroundColor: interfaceState.theme.chat.inputPanel.inputBackgroundColor,
					strokeColor: interfaceState.theme.chat.inputPanel.inputStrokeColor,
					diameter: minimalInputHeight,
					caption: self.isCaption
				)
                self.textInputContainerBackgroundNode.image = generateStretchableFilledCircleImage(
					diameter: minimalInputHeight,
