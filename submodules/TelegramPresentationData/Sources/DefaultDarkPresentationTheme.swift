...
// TODO: Ton - Theme: color resources - dark theme 
let darkCustom = CustomTheme(
	isDark: true,
	accentColor : UIColor(rgb: 0xAFC8FF),
	accent2Color : UIColor(rgb: 0xAFC8FF),
	
	aiButtonColor: UIColor(rgb: 0x131727),
	aiButtonDisabledColor: UIColor(rgb: 0x0F1322),
	aiInputBackground : UIColor(rgb: 0x1A1F29),
	aiInputTextColor : UIColor(rgb: 0xFFFFFF),
	aiInputHolderColor : UIColor(rgb: 0x666666),
	aiTranslatedColor : UIColor(rgb: 0xFFFFFF),
	
	backgroundColor : UIColor(rgb: 0x060A16),
	blurredBackgroundColor : UIColor(rgb: 0x060A16, alpha: 0.99),
	buttonTextColor: UIColor(rgb: 0x000000),
	chatDateHeaderTextColor: UIColor(rgb: 0xFFFFFF),
	defaultBlock : UIColor(rgb: 0x0b1021),
	dimColor: UIColor(rgb: 0x000000, alpha: 0.6),
	
	incomingBubble : [UIColor(rgb: 0x1A1F29),UIColor(rgb: 0x1A1F29)],
	incomingSecondaryText : UIColor(rgb: 0x80828A),
	incomingText : UIColor(rgb: 0xFFFFFF),
	inputBackground : UIColor(rgb: 0x101526),
	itemHighlightColor : UIColor(rgb: 0x0F1322),
	
	linkTextColor : UIColor(rgb: 0x3f88f7),
	modalBackground : UIColor(rgb: 0x0F1322),
	
	navBarColor : UIColor(rgb: 0x060A16),
	navBarButtonIconColor : UIColor(rgb: 0xFFFFFF),
	navBarButtonTextColor : UIColor(rgb: 0xFFFFFF),
	navBarTitleColor : UIColor(rgb: 0xFFFFFF),
	
	outgoingBubble : [UIColor(rgb: 0xAFC8FF),UIColor(rgb: 0xAFC8FF)],
	outgoingSecondaryText : UIColor(rgb: 0x000000),
	outgoingText : UIColor(rgb: 0x000000),
	
	primaryTextColor : UIColor(rgb: 0xFFFFFF),
	secondaryTextColor : UIColor(rgb: 0x80828A),
	

	selectedButton: UIColor(rgb: 0xAFC8FF),
	unselectButton: UIColor(rgb: 0x161827),
	unselectButton2: UIColor(rgb: 0x1B2134),
	selectedButtonText: UIColor(rgb: 0x000000),
	unselectButtonText: UIColor(rgb: 0x9697A3)
)
...
public func customizeDefaultDarkPresentationTheme(theme: PresentationTheme, editing: Bool, title: String?, accentColor: UIColor?, backgroundColors: [UInt32], bubbleColors: [UInt32], animateBubbleColors: Bool?, wallpaper forcedWallpaper: TelegramWallpaper? = nil, baseColor: PresentationThemeBaseColor? = nil) -> PresentationTheme {
	...
	if bubbleColors.isEmpty, editing {
		//let accentColor = accentColor ?? UIColor(rgb: 0x3A64FF)
		let accentColor = accentColor ?? UIColor(rgb: 0xAFC8FF)
		if accentColor.rgb == 0xFFFFFF {
			monochrome = true
			bubbleColors = [
				UIColor(rgb: 0x313131).rgb,
				UIColor(rgb: 0x313131).rgb
			]
		} else if accentColor.rgb == 0xAFC8FF {
			bubbleColors = [
				0x0771ff,
				0x9047ff,
				0xa256bf,
			...
			bubbleColors = [
				accentColor.withMultiplied(hue: 0.966, saturation: 0.61, brightness: 0.98).rgb,
				accentColor.rgb
			]
		}
	} else {
			...
			outgoing: chat.message.outgoing.withUpdated(
				bubble: chat.message.outgoing.bubble.withUpdated(
					withWallpaper: chat.message.outgoing.bubble.withWallpaper.withUpdated(
						...
						reactionActiveForeground: UIColor(rgb: 0x000000),
						reactionInactiveMediaPlaceholder: UIColor(rgb: 0xFFFFFF, alpha: 0.1),
						reactionActiveMediaPlaceholder: UIColor(rgb: 0xFFFFFF, alpha: 0.1)
					),
...
public func makeDefaultDarkPresentationTheme(
	...
	let list = PresentationThemeList(
		...
		itemBlocksBackgroundColor: UIColor(rgb: 0x111726),
	...
	//blocksColor: 0x111726
	let chatList = PresentationThemeChatList(
		backgroundColor: customTheme.backgroundColor,
		itemSeparatorColor: UIColor(rgb: 0x545458, alpha: 0.55),
		itemBackgroundColor: customTheme.backgroundColor,
