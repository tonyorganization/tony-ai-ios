...
//       case .dayClassic:
//			// default
//			print("Current theme: .dayClassic")
...
//       case .night:
//			// Night theme in setting
//			print("Current theme: .night")
//           theme = makeDefaultDarkPresentationTheme(extendingThemeReference: extendingThemeReference, preview: preview)
//       case .nightAccent:
//		   // Dark theme in setting
//		print("Current theme: .nightAccent")
//           theme = makeDefaultDarkTintedPresentationTheme(extendingThemeReference: extendingThemeReference, preview: preview)
//   }
//   return theme
	
		// TODO: Ton - Theme: set only 2 theme: Day and Night
	   let theme: PresentationTheme
	   switch reference {
	       case .dayClassic, .day:
	           theme = makeDefaultDayPresentationTheme(
					extendingThemeReference: extendingThemeReference,
					serviceBackgroundColor: serviceBackgroundColor,
					day: true,
					preview: preview
			   )
	       case .night, .nightAccent:
...
//        case .day, .dayClassic:
//            return customizeDefaultDayTheme(
//				theme: theme,
//				editing: editing,
//				title: title,
//				accentColor: accentColor,
//				outgoingAccentColor: outgoingAccentColor,
//				backgroundColors: backgroundColors,
//				bubbleColors: bubbleColors,
//				animateBubbleColors: animateBubbleColors ?? false,
//				wallpaper: wallpaper,
//				serviceBackgroundColor: nil
//			)
//        case .night:
//            return customizeDefaultDarkPresentationTheme(
//				theme: theme,
//				editing: editing,
//				title: title,
//				accentColor: accentColor,
