...
final class AuthorizationSequencePasswordEntryControllerNode: ASDisplayNode, UITextFieldDelegate {
    ...
    init(presentationData: PresentationData) {
        ...
        self.titleNode.attributedText = NSAttributedString(
			string: strings.LoginPassword_Title,
			font: Font.bold(20.0),
		...
		self.noticeNode.attributedText = NSAttributedString(
			string: strings.TwoStepAuth_EnterPasswordHelp,
			font: Font.regular(16.0),
			textColor: self.theme.custom.secondaryTextColor,
    ...
    func containerLayoutUpdated(_ layout: ContainerViewLayout, navigationBarHeight: CGFloat, transition: ContainedViewLayoutTransition) {
        ...
        self.titleNode.attributedText = NSAttributedString(
			string: self.strings.LoginPassword_Title,
			font: Font.bold(20.0),
			textColor: self.theme.custom.accentColor
		)
...
//            items.insert(AuthorizationLayoutItem(node: self.animationNode, size: animationSize, spacingBefore: AuthorizationLayoutItemSpacing(weight: 10.0, maxValue: 10.0), spacingAfter: AuthorizationLayoutItemSpacing(weight: 0.0, maxValue: 0.0)), at: 0)
			items.insert(AuthorizationLayoutItem(node: self.lockImageNode, size: animationSize, spacingBefore: AuthorizationLayoutItemSpacing(weight: 10.0, maxValue: 10.0), spacingAfter: AuthorizationLayoutItemSpacing(weight: 0.0, maxValue: 0.0)), at: 0)
            self.proceedNode.isHidden = false
  
			// TODO: Ton - Password: hide animation
