                        ...
                        if canSave {
                            ...
                            if allowSaving {
                                present(textAlertController(
									context: strongSelf.context,
									title: nil,
									text: strongSelf.presentationData.strings.Checkout_NewCard_SaveInfoEnableHelp.replacingOccurrences(of: "]", with: "").replacingOccurrences(of: "[", with: ""),
