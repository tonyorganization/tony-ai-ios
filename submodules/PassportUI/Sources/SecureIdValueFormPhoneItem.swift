...
final class SecureIdValueFormPhoneItemNode: FormBlockItemNode<SecureIdValueFormPhoneItem> {
    ...
    override func update(item: SecureIdValueFormPhoneItem, theme: PresentationTheme, strings: PresentationStrings, dateTimeFormat: PresentationDateTimeFormat, width: CGFloat, previousNeighbor: FormControllerItemNeighbor, nextNeighbor: FormControllerItemNeighbor, transition: ContainedViewLayoutTransition) -> (FormControllerItemPreLayout, (FormControllerItemLayoutParams) -> CGFloat) {
        if self.theme !== theme {
            ...
            self.phoneInputNode.dialingTextNode.textField.textColor = theme.list.itemPrimaryTextColor
            self.phoneInputNode.phoneNumberNode.textField.textColor = theme.list.itemPrimaryTextColor
            
            self.phoneInputNode.dialingTextNode.textField.tintColor = theme.list.itemAccentColor
            self.phoneInputNode.phoneNumberNode.textField.tintColor = theme.list.itemAccentColor
            
            self.phoneInputNode.dialingTextNode.textField.keyboardAppearance = theme.rootController.keyboardColor.keyboardAppearance
            self.phoneInputNode.phoneNumberNode.textField.keyboardAppearance = theme.rootController.keyboardColor.keyboardAppearance
        }
        ...
        return (FormControllerItemPreLayout(aligningInset: 0.0), { params in
            ...
            self.phoneInputNode.phoneNumberNode.textField.attributedPlaceholder = NSAttributedString(string: strings.Login_PhonePlaceholder, font: Font.regular(17.0), textColor: theme.list.itemSecondaryTextColor)
    ...
    func activate() {
        self.phoneInputNode.phoneNumberNode.becomeFirstResponder()
    }
}
