...
private var declaredEncodables: Void = {
	...
	// TODO: Ton - Translate: declareEncodable for TranslateTextMessageAttribute
	declareEncodable(TranslateTextMessageAttribute.self, f: { TranslateTextMessageAttribute(decoder: $0) })
    return
}()
...
// TODO: Ton - Translate: TranslateTextMessageAttribute
public final class TranslateTextMessageAttribute: Equatable, MessageAttribute {
	public let isShow: Bool
	public let lang: String
	public let text: String
	public init(isShow: Bool, lang: String, text: String) {
		self.isShow = isShow
		self.lang = lang
		self.text = text
	}
	
	// MARK: - MessageAttribute
	...
	// MARK: - Codable (Postbox)
	public init(decoder: PostboxDecoder) {
		self.isShow = decoder.decodeBoolForKey("show", orElse: true)
		self.lang = decoder.decodeStringForKey("lang", orElse: "")
		self.text = decoder.decodeStringForKey("text", orElse: "")
	}
	
	public func encode(_ encoder: PostboxEncoder) {
		encoder.encodeBool(self.isShow, forKey: "show")
		encoder.encodeString(self.lang, forKey: "lang")
		encoder.encodeString(self.text, forKey: "text")
	}
	
	public static func ==(lhs: TranslateTextMessageAttribute, rhs: TranslateTextMessageAttribute) -> Bool {
		return lhs.isShow == rhs.isShow && lhs.lang == rhs.lang && lhs.text == rhs.text
	}
}
